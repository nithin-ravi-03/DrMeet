  ...
  return docInfo ? (
    <div>
        ...
        <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
            ...
            key={index}
            className={`text-center py-4 px-2 min-w-16 rounded-full cursor-pointer transition-all duration-200 ease-in-out ${slotIndex === index ? 'bg-primary text-white shadow-md scale-105' : 'border border-gray-200 hover:shadow-sm'}`}>
